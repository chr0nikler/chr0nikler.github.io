...
1. This book should fall under the genre of "historical fiction." It uses resources that are well known that document Joan of Arc's life, but it's a story written by a fiction author, Mark Twain. It's like the difference between a biography and an autobiography. One is an attempt at pure facts, the other is facts tainted by personal bias. Only in this case, it's Twain's personal bias about Catholicism combined with a random fascination for Joan of Arc injected into an autobiographical format via a fictional person close to her.
